        ...
        public static function get_demos_data() {
            ...
            $enwoo_data = array(
				'free-demo-8' => array(
					...
					'demo_link' => 'http://enwoo-demos.com/free-demo-8/',
                ...
                'free-demo-1' => array(
					...
					'demo_link' => 'http://enwoo-demos.com/free-demo-1/',
                ...
                'free-demo-2' => array(
					...
					'demo_link' => 'http://enwoo-demos.com/free-demo-2/',
                ...
                'free-demo-3' => array(
					...
					'demo_link' => 'http://enwoo-demos.com/free-demo-3/',
				...
				'free-demo-4' => array(
					...
					'demo_link' => 'http://enwoo-demos.com/free-demo-4/',
				...
				'free-demo-5' => array(
					...
					'demo_link' => 'http://enwoo-demos.com/free-demo-5/',
				...
				'free-demo-6' => array(
					...
					'demo_link' => 'http://enwoo-demos.com/free-demo-6/',
				...
				'free-demo-7' => array(
					...
					'demo_link' => 'http://enwoo-demos.com/free-demo-7/',
                ...
                <div class="envo-popup-text">
                    ...
                    <div class="envo-required-plugins-wrap">
						...
						<?php if ((isset($required_theme) && !empty($required_theme)) && ($theme->name != $required_theme) ) { ?>
							...
							<p><?php echo sprintf( esc_html__('This demo requires a different active theme. Theme %1$s will be activated after the successful import.', 'envothemes-demo-import'), '<a href="' . esc_url('https://enwoo-wp.com/') . '" target="_blank">' . esc_html($required_theme) . '</a>');?></p>
                        <?php } ?>
                    </div>
